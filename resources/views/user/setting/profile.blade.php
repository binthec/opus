	...
	<div role="tabpanel">
		...
		<div class="tab-content">
			<div class="profile-pic-setting">
				<h2>@lang('menu.ProfilePicture')</h2>
				<div class="media">
					<div class="pull-left">
			...
			<div class="user-info">
				...
				<form action="{{ route('users.update', [$team->slug, Auth::user()->slug]) }}" method="POST" role="form">
					...
					<input type="submit" class="btn btn-success update-btn" value="@lang('function.Update')">  
				</form>
			</div>
		</div>
	</div>
