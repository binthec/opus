...
<div class="aside-content">
	<div class="row no-container">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header"><i class="fa fa-check-square-o fa-fw fa-lg icon"></i> @lang('menu.ReadList')</div>
							...
							<div class="media-body">
								<div class="wiki-top">
									...
									<div class="pull-right" style="margin-right: 15px;">
										@if($item->subject_type === 'App\Models\Wiki')
										<object><a href="{{ route('wikis.readlater.destroy', [$team->slug, $item->subject->space->slug, $item->subject->slug]) }}" data-method="delete" data-toggle="tooltip" data-placement="top" title="@lang('message.RemoveFromReadList')"><i class="fa fa-trash-o icon"></i></a></object>
										@else
