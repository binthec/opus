			...
			<ul class="nav navbar-nav navbar-right">
				<form class="navbar-form navbar-left dropdown" role="search">
					<div class="form-group with-icon dropdown-toggle" data-toggle="dropdown" >
						<input type="text" class="form-control overall-search-input" placeholder="@lang('message.EnterSearch')">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right" style="margin-top: -3px; margin-right: -6px; margin-top: -3px; padding: 4px 5px;">
                        <li><a href="{{ route('wikis.create', [ $team->slug ]) }}" style="padding: 5px 6px;">@lang('function.CreateWiki')</a></li>
                        <li><a href="{{ route('spaces.create', [ $team->slug ]) }}" style="padding: 5px 6px;">@lang('function.Createspace')</a></li>
                        <li class="divider" style="margin: 0px;"></li>
                        <li><a href="{{ route('teams.settings.members', [$team->slug,]) }}" style="padding: 5px 6px;">@lang('function.Inviteuser')</a></li>
                    </ul>
				</li>
				<li class="dropdown">
                        ...
                        <div class="menu-notifications">
							<div class="notification-head" style="padding: 12px 15px;">
								<div class="pull-left" style="height: 18px; display: flex; align-items: center;">
									<h2 style="font-size: 12px; color: #777;">@lang('menu.Notifications')</h2>
								</div>
							...
							<div class="notification-body" style="max-height: 260px; overflow: auto; margin-bottom: 15px;">
								...
								<div style="font-size: 12px; text-align: center; padding: 2px 15px 20px; color: #777;">
									...
									@lang('message.NoUnreadNotification')
								</div>
								@endif
							</div>
                        </div>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right" style="margin-top: -3px; padding: 4px 5px;">
                        <li><a href="{{ route('users.show', [$team->slug, Auth::user()->slug]) }}" style="padding: 5px 6px;">@lang('menu.Profile')</a></li>
                        <li><a href="{{ route('settings.profile', [$team->slug, Auth::user()->slug]) }}" style="padding: 5px 6px;">@lang('menu.Settings')</a></li>
                        <li class="divider" style="margin: 0px; background-color: #eee;"></li>
                        <li><a href="{{ route('logout') }}" style="padding: 5px 6px;">@lang('menu.Logout') </a></li>
                    </ul>
				</li>
			</ul>
		</div>
