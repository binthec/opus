                                        ...
                                        <div class="pull-right">
                                            <ul class="list-unstyled list-inline">
                                                ...
                                                @if($group->slug !== 'admins') 
                                                    <li>
                                                        <a href="{{ route('roles.delete', [$team->slug, $group->slug]) }}" data-method="delete" data-confirm="@lang('message.AreYouSure')"><i class="fa fa-trash-o fa-fw" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </div>
