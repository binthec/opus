...
<div class="team-setting">
	<div class="team-setting-header">
		@lang('menu.TeamSettings')
	</div>
	<div role="tabpanel">
		@include('team.partials.tab-menu')
		<div class="tab-content">
			<div class="team-info">
				<h2>@lang('menu.TeamName')</h2>
				...
				<form action="{{ route('teams.update', [ $team->slug ]) }}" method="POST" class="form-inline" role="form">
					...
					<button type="submit" class="btn btn-success pull-right">@lang('function.Save')</button>
					<div class="clearfix"></div>
				</form>
			</div>
			<div class="team-logo">
				<h2>@lang('menu.TeamLogo')</h2>
				<div class="media">
					<div class="pull-left">
						@if($team->team_logo)
