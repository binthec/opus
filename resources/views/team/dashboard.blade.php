...
<div class="aside-content">
  <div class="row no-container">
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
	  <div class="page-header"><i class="fa fa-history fa-fw fa-lg icon"></i> @lang('menu.Activities')</div>
	  ...
	  <div data-spy="affix" data-offset-top="1">
		...
		<div class="panel panel-more">
		  <div class="panel-heading">
			<i class="fa fa-history fa-fw" style="margin-right: 3px;"></i> @lang('menu.RecentWikis')
		  </div>
		...
		<div class="panel panel-more">
		  <div class="panel-heading" style="position: relative;">
			<i class="fa fa-star-o fa-fw" style="margin-right: 3px;"></i> @lang('menu.FavouriteWikis')
