...
class RoleController extends Controller
{
	...
	public function store(Team $team)
	{
		...
		return redirect()->route('roles.index', [$team->slug])->with([
					'alert' => trans('message.SuccessfullyCreated', ['name' => trans('menu.Role')]),
					'alert_type' => 'success',
		]);
	}
	...
	public function update(Team $team, Role $role)
	{
		...
		return redirect()->route('roles.index', [$team->slug])->with([
					'alert' => trans('message.SuccessfullyUpdated', ['name' => trans('menu.Role')]),
					'alert_type' => 'success',
		]);
	}
	...
	public function destroy(Team $team, Role $role)
	{
		...
		return redirect()->route('roles.index', [$team->slug])->with([
					'alert' => trans('message.SuccessfullyDeleted', ['name' => trans('menu.Role')]),
					'alert_type' => 'success',
		]);
	}
