...
class TeamController extends Controller
{
	...
	public function update(Team $team)
	{
		if ($team->name === $this->request->get('team_name')) {
			return redirect()->back()->with([
						'alert' => trans('message.SuccessfullyUpdated', ['name' => trans('menu.TeamName')]),
						'alert_type' => 'success',
			]);
		}
	...
	public function destroy(Team $team)
	{
		...
		return redirect()->route('team.login')->with([
					'alert' => trans('message.SuccessfullyDeleted', ['name' => trans('menu.Team')]),
					'alert_type' => 'success',
		]);
	}
	...
	public function postLogin()
	{
		...
		return redirect()->back()->withErrors([
					'wrong_credential' => trans('message.LoginNotValid'),
		]);
	}
